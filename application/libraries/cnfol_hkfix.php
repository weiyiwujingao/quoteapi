...
class Cnfol_hkfix
{
	...
	*/
	...
	(
		'server'    => 'gw.hkprice.store.cnfol.net',
		'port'      => 888,
		'timeout'   => 10,
		'userid'    => 0,
		'productid' => 10,
	 ...
	 * @return void
	 */
    public function __construct($keys = 'cnfolhkfix')
	{
		$this->split = chr(1);
   ...
   /**
	...
	{
		!defined('APPPATH') && exit('cnfol_hkfix:`APPPATH` constants undefined');
...
/* End of file cnfol_hkfix.php */
/* Location: ./application/libraries/cnfol_hkfix.php */