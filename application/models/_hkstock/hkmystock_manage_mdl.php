 ...
 ****************************************************************/
class HKMystock_manage_mdl extends CI_Model
{
	/* 添加自选股 */
	const HK_U_INSERT_STOCK = 'U713';
	/* 删除自选股 */
	const HK_U_DELETE_STOCK = 'U714';	
	/* 查询自选股 */
	const HK_U_SELECT_STOCK = 'U715';
   ...
   /**
	 ...
	 * @return array
     */
    public function get_stock_by_id($where)
    {
		$data = $this->cnfol_socket->senddata(self::HK_U_SELECT_STOCK, $where);
   ...
   /**
    ...
    {
		$keys = get_keys(self::HK_U_SELECT_STOCK, $where['UserID'], $where['Type']);
   ...
   /**
    ...
    {
		$result = $this->cnfol_socket->senddata(self::HK_U_INSERT_STOCK, $data);
        ...
        {
			$keys = get_keys(self::HK_U_SELECT_STOCK, $data['UserID'], $data['Type']);
   ...
   /**
    ...
    public function update_stock($data)
    {
		...
		if($result['Code'] == '00' && $result['TtlRecords'] > 0)
        {
			...
			return $this->cnfol_mem->delete($keys);
		}
        else
        {
			return FALSE;
   ...
   /**
    ...
    {
		$result = $this->cnfol_socket->senddata(self::HK_U_DELETE_STOCK, $where);
   ...
   /**
    ...
    {
		$keys = get_keys('hkmystock_limit_time', $userid);
...
/* End of file hkmystock_manage_mdl.php */
/* Location: ./application/models/_hkstock/hkmystock_manage_mdl.php */